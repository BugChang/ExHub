...
public class User : IUser
{
    ...
    public string SoldCode
    {
        get
        {
            var soldCode = _accessor?.HttpContext?.User.FindFirst("SoldCode");

            if (soldCode != null && soldCode.Value.NotNull())
            {
                return soldCode.Value;
            }
    ...
    public List<string> RoleNames
    {
        get
        {
            var roleNames = _accessor?.HttpContext?.User.FindFirst("RoleNames");

            if (roleNames != null && roleNames.Value.NotNull())
            {
                return roleNames.Value.Split(",").ToList();
            }
